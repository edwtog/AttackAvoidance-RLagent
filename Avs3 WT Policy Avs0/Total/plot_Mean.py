...
#plt.subplot(1,4,1)
plt.plot(1)
plt.title('Avs3 transfer from Avs0 - NN Avs3 13-19-1 - NN Avs0 7-7-1')
...
plt.title('Avs3 transfer from Avs0 - NN Avs3 13-19-1 - NN Avs0 7-7-1', fontsize=20)
...
plt.grid()
plt.savefig('Avs3WTpolicyAvs0 winningProb.png', bbox_inches='tight')
...
plt.savefig('Avs3WTpolicyAvs0 meanReinforcement.png', bbox_inches='tight')
plt.show()
