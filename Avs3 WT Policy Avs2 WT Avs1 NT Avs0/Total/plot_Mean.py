...
#plt.subplot(1,4,1)
plt.plot(1)
plt.title('Avs3 transfer from Avs2 & Avs1 - NN Avs3 13-19-1')
...
plt.title('Avs3 transfer from Avs2 & Avs1 - NN Avs3 13-19-1', fontsize=20)
...
plt.grid()
plt.savefig('Avs3WTpolicyAvs2WTAvs1NTAvs0 winningProb.png', bbox_inches='tight')
##########################################################
### Mean reinforcement
##########################################################
...
plt.tick_params(axis='y', labelsize=14)
plt.grid()
plt.savefig('Avs3WTpolicyAvs2WTAvs1NTAvs0 meanReinforcement.png', bbox_inches='tight')
##########################################################
