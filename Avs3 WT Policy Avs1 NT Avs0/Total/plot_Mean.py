...
#plt.subplot(1,4,1)
plt.plot(1)
plt.title('Avs3 transfer from Avs1 - NN Avs3 13-19-1 - NN Avs1 9-10-1')
...
plt.title('Avs3 transfer from Avs1 - NN Avs3 13-19-1 - NN Avs1 9-10-1', fontsize=20)
...
plt.grid()
plt.savefig('Avs3WTpolicyAvs1NTAvs0 winningProb.png', bbox_inches='tight')
...
plt.tick_params(axis='y', labelsize=14)
plt.grid()
plt.savefig('Avs3WTpolicyAvs1NTAvs0 meanReinforcement.png', bbox_inches='tight')
